      ...
      .then((res) => {
        ...
        if (res["Errors"] == null) {
          ...
          for (var match in res) {
            ...
            let matchData = {team: rawMatchData.alliances.blue.team_keys[1].replace("frc", ""), matchNo: rawMatchData.key.replace(`${eventKey}_`, "").replace("m", "").toUpperCase(), scouted: false, scouter: ""};
